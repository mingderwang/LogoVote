...
import { Counter2 } from 'routes/Counter2/components/Counter2'
import { shallow } from 'enzyme'

describe('(Component) Counter2', () => {
  ...
  beforeEach(() => {
    ...
    _wrapper = shallow(<Counter2 {..._props} />)
  })
  ...
  it('renders with an <h2> that includes Counter label.', () => {
    expect(_wrapper.find('h2').text()).to.match(/Counter2:/)
  })
